...
void printToken(Token *token) {
  ...
  case TK_NONE: printf("TK_NONE"); break;
  ...
  case KW_ARRAY: printf("ARRAY\n"); break;
  case KW_OF: printf("OF\n"); break;
  case KW_FUNCTION: printf("FUNCTION\n"); break;
  case KW_PROCEDURE: printf("PROCEDURE\n"); break;
  case KW_BEGIN: printf("BEGIN\n"); break;
  case KW_END: printf("END\n"); break;
  case KW_CALL: printf("CALL\n"); break;
  case KW_IF: printf("IF\n"); break;
  case KW_THEN: printf("THEN\n"); break;
  case KW_ELSE: printf("ELSE\n"); break;
  case KW_WHILE: printf("WHILE\n"); break;
  case KW_DO: printf("DO\n"); break;
  case KW_FOR: printf("FOR\n"); break;
  case KW_TO: printf("TO\n"); break;
